<template>
    ...
    <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center" width="100%"
        ...
        <hero-image-flush :full-image="refcard.test.img" :size="refcard.test.size"></hero-image-flush>
        ...
        <title-table title="Nos meilleurs Tweets du trimestre"></title-table>

        <hero-image-flush :full-image="twitter.first.img" :size="twitter.first.size" :link="twitter.first.link"></hero-image-flush>
        <hero-image-flush :full-image="twitter.second.img" :size="twitter.second.size" :link="twitter.second.link"></hero-image-flush>
        <hero-image-flush :full-image="twitter.third.img" :size="twitter.third.size" :link="twitter.third.link"></hero-image-flush>
        <hero-image-flush :full-image="twitter.fourth.img" :size="twitter.fourth.size" :link="twitter.fourth.link"></hero-image-flush>
        <hero-image-flush :full-image="twitter.fifth.img" :size="twitter.fifth.size" :link="twitter.fifth.link"></hero-image-flush>
